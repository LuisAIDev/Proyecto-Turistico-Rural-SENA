...
router.get('/estadisticas', verificarToken, reservasController.getDashboardStats);

// 6. Facturación / flujo de caja
router.get('/facturacion', verificarToken, reservasController.getFacturacion);

// 7. KPI rentabilidad (alojamiento con más ingresos)
